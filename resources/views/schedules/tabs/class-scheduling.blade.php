...
@else
    ...
    <div class="bg-white px-6 py-4 border-b border-gray-200">
        ...
        <div class="flex justify-between items-center space-x-4">
            <!-- Left Group: Search + Date + Day + Status -->
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm">
                        <span
                            class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Partially
                            Assigned</span>
                    </td>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm text-center text-gray-500">10</td>
                    <td class="px-6 py-4 text-sm">
                        <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Fully
                            Assigned</span>
                    </td>
                    <td class="px-6 py-4 text-sm">
