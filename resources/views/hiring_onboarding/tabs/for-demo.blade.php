...
<tbody class="bg-white divide-y divide-gray-200">
    ...
    <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Zoom-001</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Mon - Fri | 7 AM - 3 PM</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Needs follow-up</td>
        <td class="px-6 py-4 whitespace-nowrap">
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#65DB7F] text-[#006022]">
                Screening
            </span>
        </td>
    ...
    <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Zoom-002</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Mon - Wed | 7 AM - 4 PM</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Did not answer</td>
        <td class="px-6 py-4 whitespace-nowrap">
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#FBBF24] text-[#6C5600]">
                Demo
            </span>
        </td>
        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
    ...
    <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Zoom-003</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Mon - Fri | 10 AM - 3 PM</td>
        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Rescheduled</td>
        <td class="px-6 py-4 whitespace-nowrap">
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#9DC9FD] text-[#2C5B8C]">
                Training
            </span>
        </td>
        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
