...
<div class="bg-white rounded-xl shadow-md p-6 sm:p-10" x-data="{ 
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    @if($application->main_device)
                        <a href="{{ $application->main_device }}" target="_blank" 
                           class="text-base font-medium text-blue-600 hover:text-blue-800 px-3 py-2 bg-gray-50 rounded-md break-all">
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    @if($application->backup_device)
                        <a href="{{ $application->backup_device }}" target="_blank" 
                           class="text-base font-medium text-blue-600 hover:text-blue-800 px-3 py-2 bg-gray-50 rounded-md break-all">
    ...
    <!-- Page 5: Status & Actions -->
    <div x-show="currentPage === 5" x-transition:enter="transition ease-out duration-300"
         x-transition:enter-start="opacity-0 transform translate-x-4"
         x-transition:enter-end="opacity-100 transform translate-x-0">
        <h3 class="font-semibold text-[#0E335D] text-xl mb-6 flex items-center">
            <i class="fas fa-info-circle mr-2 text-[#65DB7F]"></i>
            Application Status
        </h3>
        
        <div class="space-y-6">
            <!-- Status Card -->
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-xl shadow-sm">
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="flex flex-col space-y-1">
                        <label class="text-xs font-semibold text-gray-500 uppercase tracking-wide">Current Status</label>
                        <div class="flex items-center gap-2">
                            <span class="px-4 py-2 rounded-full text-sm font-bold {{ $application->statusColor() }}">
                    ...
                    <div class="flex flex-col space-y-1">
                        <label class="text-xs font-semibold text-gray-500 uppercase tracking-wide">Attempt Count</label>
                        <div class="text-2xl font-bold text-gray-900">
                            {{ $application->attempt_count }}/3
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex flex-col space-y-1 md:col-span-2">
                        <label class="text-xs font-semibold text-gray-500 uppercase tracking-wide">Last Interviewer</label>
                        <div class="text-base font-medium text-gray-900 px-3 py-2 bg-white rounded-md">
            ...
            <div class="flex justify-center pt-6">
                <button type="button" @click="showModal = true"
                    class="px-12 py-4 rounded-full bg-[#234D7C] text-white text-lg font-semibold hover:opacity-90 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
