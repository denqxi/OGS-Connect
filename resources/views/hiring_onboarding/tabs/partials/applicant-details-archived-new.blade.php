...
<div class="bg-white rounded-xl shadow-md p-6 sm:p-10" x-data="{ 
    ...
    closeFailModal() {
        ...
        this.$nextTick(() => {
            ...
            setTimeout(() => {
                window.location.href = '{{ route('hiring_onboarding.applicant.show', $archivedApplication->application_id) }}';
            }, 2000);
        });
    },
    closePassModal() {
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    @if($archivedApplication->main_device)
                        <a href="{{ $archivedApplication->main_device }}" target="_blank" 
                           class="text-base font-medium text-blue-600 hover:text-blue-800 px-3 py-2 bg-gray-50 rounded-md break-all">
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    @if($archivedApplication->backup_device)
                        <a href="{{ $archivedApplication->backup_device }}" target="_blank" 
                           class="text-base font-medium text-blue-600 hover:text-blue-800 px-3 py-2 bg-gray-50 rounded-md break-all">
