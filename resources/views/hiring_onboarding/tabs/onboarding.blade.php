    ...
    <table class="w-full">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-600 underline">jane.smith@gmail.com</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Zoom-010</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Mon - Fri | 9 AM - 5 PM</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Onboarding in progress</td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#A78BFA] text-white">
                        Onboarding
                    </span>
                </td>
