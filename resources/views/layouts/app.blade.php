...
<head>
    ...
    @if(auth('supervisor')->user())
        <meta name="supervisor-id" content="{{ auth('supervisor')->user()->supID ?? auth('supervisor')->user()->id }}">
        <meta name="supervisor-name" content="{{ auth('supervisor')->user()->full_name ?? auth('supervisor')->user()->name ?? 'Unknown' }}">
        <meta name="supervisor-db-id" content="{{ auth('supervisor')->user()->supervisor_id ?? auth('supervisor')->user()->id }}">
    @endif
